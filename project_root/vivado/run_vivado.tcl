...
# ===================================================================
# START OF MODIFICATION: Manually set PL Clock 0 to 200 MHz
# ===================================================================
set_property -dict [list CONFIG.PSU__CRL_APB__PL0_REF_CTRL__FREQMHZ {250.000}] [get_bd_cells zynq_ultra_ps_e_0]
# ===================================================================
# END OF MODIFICATION
# ===================================================================
# 启用PL到PS中断
...
launch_runs ${design_name}_zynq_ultra_ps_e_0_0_synth_1 ${design_name}_activation_accelerat_0_0_synth_1 ${design_name}_auto_pc_0_synth_1 ${design_name}_rst_ps8_0_100M_0_synth_1 ${design_name}_auto_pc_1_synth_1 ${design_name}_auto_us_0_synth_1 -jobs 64
